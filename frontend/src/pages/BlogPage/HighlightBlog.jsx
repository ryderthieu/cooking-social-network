...
const HighlightBlog = () => {
  return (
    <div>
      <div className="px-[300px] pt-[30px] pb-[20px]">
        ...
        <div className="flex">
          <div className="w-[70%]">
            ...
            <p className="text-[rgba(0,0,0,0.6)] mb-4 leading-7 text-justify">
              ...
              chua, nhưng không quá gắt, có hậu vị hơi thơm giống họ quýt và
              bưởi, tinh dầu trong quả yuzu tạo ra mùi hương đặc biệt, thường
              được dùng trong ẩm thực ví dụ như làm sốt, đồ uống, bánh trái, trà
              và sản xuất nước hoa…
            </p>
            ...
            <p className="text-[rgba(0,0,0,0.6)] mb-4 leading-7 text-justify">
              ...
              nhưng nguồn cung lại chưa đủ. Cây yuzu thường được trồng ở Đông Á
              và khó canh tác ở những vùng đất khác, cần khá nhiều năm để cây ra
              quả. Hơn nữa nước trong yuzu khá ít, để không làm hư hại trái yuzu
              người ta phải thu hoạch quả bằng tay mà giá nhân công không hề rẻ,
              do đó giá thành yuzu bị đội lên rất nhiều. Cách dễ tìm hơn là bạn
              có thể tìm mua nước cốt yuzu đóng chai, và nếu pha trà làm bánh
              thì mua hũ mứt yuzu (yuzu honey) (chắc ở châu Âu đây là cách duy
              nhất), dù nó vẫn đắt so với các hũ mứt quả khác.
            </p>
      ...
      <div className="my-[20px] px-[300px]">
