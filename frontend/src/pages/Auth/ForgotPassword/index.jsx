...
const ForgotPassword = () => {
    ...
    const handlePasswordResetSubmit = (e) => {
        ...
        if (Object.keys(validationErrors).length > 0) {
            ...
            console.log("Đặt lại mật khẩu cho email:", email, "Mật khẩu mới:", newPassword);
                    ...
                    <div className="w-full max-w-md">
                        ...
                        {step === 'enterOtp' && (
                            <>
                                ...
                                <p className="text-sm text-center text-gray-600 mt-6">
                                    <button onClick={() => setStep('enterEmail')} className="text-blue-600 hover:text-blue-800 font-medium transition duration-300 ease-in-out">
                                        Nhập lại Email?
                                    </button>
                                </p>
                            </>
