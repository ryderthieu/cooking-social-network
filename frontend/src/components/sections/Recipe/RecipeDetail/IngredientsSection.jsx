...
import { formatQuantity, calculateIngredientQuantity } from "../../../../utils/recipeUtils";
import { useState, useEffect, useRef } from "react";

export default function IngredientsSection({ recipe, servings, setServings }) {
                ...
                {servingOptions.map((option) => (
                  <div
                    ...
                    className={`px-3 py-2 cursor-pointer hover:bg-gray-50 text-center ${
                      option === servings ? 'bg-orange-50 text-orange-600 font-medium' : ''
                    }`}
