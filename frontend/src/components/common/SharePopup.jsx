...
import { FaTimes, FaCopy, FaFacebook, FaTwitter, FaComments, FaSearch } from 'react-icons/fa';
            ...
            <div className="max-h-60 overflow-y-auto">
              {loading ? (
                ...
                filteredConversations.map(conv => (
                  ...
                  >
                    <img
                      src={getConversationAvatar(conv) || 'https://via.placeholder.com/150'}
                    ...
                    <div className="flex-1 text-left">
                      <div className="font-medium text-gray-800">{getConversationName(conv)}</div>
                      <div className="text-sm text-gray-500">{getLastActive(conv)}</div>
                    </div>
