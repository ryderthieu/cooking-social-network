...
const categoryService = {
  ...
  getCategoryBySlugAndType: (type, slug) =>
    API.get(`${endpoint}/${type}/${slug}`),
  ...
  updateCategory: (id, categoryData) =>
    API.put(`${endpoint}/${id}`, categoryData),
  ...
  getMealTypes: (limit = null) =>
    categoryService.getCategoriesByType("mealType", limit),

  getCuisines: (limit = null) =>
    categoryService.getCategoriesByType("cuisine", limit),

  getOccasions: (limit = null) =>
    categoryService.getCategoriesByType("occasions", limit),

  getDietaryPreferences: (limit = null) =>
    categoryService.getCategoriesByType("dietaryPreferences", limit),

  getMainIngredients: (limit = null) =>
    categoryService.getCategoriesByType("mainIngredients", limit),
  
  getCookingMethods: (limit = null) =>
    categoryService.getCategoriesByType("cookingMethod", limit),
};
...
export const getAllFormattedCategories = () =>
  API.get(`${endpoint}/all-formatted`);
